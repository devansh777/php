...
<body onload="hideotherinfo()">
    ...
    <div id="other">
        ...
        <select name="other[clients]">
            ...
            <option value="<?php echo $value;?>"<?php echo in_array($value,[getFieldValue('other','clients')]) ? 'selected="selected"':'';?>> <?php echo $value ?></option>
            <?php endforeach ?>
         </select><br>
        How do you like us to get in touch with you?<br>
        <?php foreach($gettouch as $value):?>
            <?php $select= in_array($value,getFieldValue('other','gettouch',[])) ? 'checked':'';?> 
        ...
        Hobbies :<select multiple name="other[hobbie][]">
                    ...
                    <option value="<?php echo $value;?>"<?php echo in_array($value,getFieldValue('other','hobbie',[])) ? 'selected':'';?>> <?php echo $value ?></option>
                    <?php endforeach ?>
                </select><br>
    </fieldset>
    </div>
